<template>
  <main id="home">
    ...
    <div
      class="w-full bg-primary-red h-16 z-0 flex gap-3 justify-center items-center text-white text-md font-bebas"
    >
      Focused training programs tailored to your needs.
      <span class="font-bold text-black"> Start now!</span>
    </div>
  </main>
