      ...
      <div class="flex flex-col md:flex-row justify-between gap-10 mt-5">
        ...
        <p class="leading-9 md:text-md w-full md:w-1/2 text-gray-800 text-md">
          ...
          <span class="block mt-5">
            Our mission is to inspire and empower individuals to lead healthier lives through
            personalized fitness and nutrition programs. combining physical training, mental
            well-being, and nutritional guidance to help you achieve optimal results.
          </span>
        </p>
      </div>
    </div>
